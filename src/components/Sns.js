        ...
        <hr style = {
            {
                ...
                <br/><br/><br/><br/><br/><br/>
                        ...
                        <br/><br/><br/><br/>
                        <br/>
                        LIKELION KNU 소개, 조직도, 공지사항 등은 페이스북과 인스타그램을 <br/>
                        통해 관리하고 있습니다.
                        <br/>
                        <br/>
                        바로가기 ↓<br/>
                ...
                <hr style = {
            {
                ...
                <h4>
                        ...
                        <br/><br/><br/><br/><br/><br/>
                        <br/><br/>
                        각 파트별 세션 정리, 관련 코드 , 프로젝트 진행 상황 등은 notion과<br/>
                        GitHub 을 통해 관리하고 있습니다.
                        <br/>
                        <br/>
                        바로가기 ↓<br/>
                        노션 ▷  
                        <Link to="https://www.notion.so/eb8ccb8683854eb3a68384ca2e82439b" target="_blank">
                          NOTION
                        </Link>
                        <br/>
                        깃허브 ▷  
